...
class ComparisonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comparison" do
    assert_difference('Comparison.count') do
      post comparisons_url, params: { comparison: { choice: @comparison.choice, record_id: @comparison.record_id, user_id: @comparison.user_id } }
    end
  ...
  test "should update comparison" do
    patch comparison_url(@comparison), params: { comparison: { choice: @comparison.choice, record_id: @comparison.record_id, user_id: @comparison.user_id } }
